...
public final class StringtoDateCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action(parameters.get("datestring") != null ? (String)parameters.get("datestring").get() : (String)null ,parameters.get("format") != null ? (String)parameters.get("format").get() : (String)null ,parameters.get("formatlocale") != null ? (String)parameters.get("formatlocale").get() : (String)null ));
