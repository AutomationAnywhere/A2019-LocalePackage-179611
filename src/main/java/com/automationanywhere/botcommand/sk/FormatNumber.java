...
@CommandPkg(label = "Converts String to Number ", name = "stringtonumber",
        ...
        node_label = "Converts String to Number", icon = "pgk.svg",comment = true , background_color =  "#86c2ff" ,
        return_type=DataType.NUMBER, return_label="Number Value", return_required=true)
public class FormatNumber {
    ...
    public NumberValue action(@Idx(index = "1", type = TEXT)  @Pkg(label = "Number String" , default_value_type = STRING) @NotEmpty String numberstring,
                              @Idx(index = "2", type = TEXT) @Pkg(label = "Locale"  , default_value_type = STRING , default_value = "en") @NotEmpty String formatlocale) throws Exception
     {
